...
const JARVIS_PERSONALITIES = {
  ...
  tony: {
    ...
    failure: "Oof. That didn't work. Want me to try something else?",
  ...
  protective: {
    ...
    failure: "I couldn't block that. Escalating to parent immediately.",
  ...
  friday: {
    id: 'friday',
    name: 'F.R.I.D.A.Y.',
    greeting: "Hi! I'm MANU, your personal A.I. How can I help?",
    success: "All done! You're doing great!",
    failure: "Oh no, that didn't work. Let me try another way!",
